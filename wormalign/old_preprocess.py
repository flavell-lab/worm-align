...
def generate_pregistered_images(
    ...
    with open("resources/euler_parameters_ALv0.json", "r") as f:
        euler_parameters_dict = json.load(f)

    with open(f"resources/eulergpu_outcomes_ALv0.json", "r") as f:
        outcomes = json.load(f)

    with open(f"resources/center_of_mass_ALv0.json", "r") as f:
        CM_dict = json.load(f)

    with open("resources/subset_ALv0.json", 'r') as f:
        registration_problem_dict = json.load(f)
    ...
    #for dataset_name, problems in registration_problem_dict["test"].items():
        ...
        for dataset_name, problems in problem_dict.items():
            ...
            write_to_json(outcomes, "eulergpu_outcomes_ALv0")
            write_to_json(CM_dict, "center_of_mass_ALv0")
            write_to_json(euler_parameters_dict, "euler_parameters_ALv0")
...
if __name__ == "__main__":
    ...
    batch_size = 200
    device_name = torch.device("cuda:2")
    ...
    generate_pregistered_images(
               target_image_shape,
               "/home/alicia/data_personal/wormalign/datasets",
               batch_size,
               device_name)
